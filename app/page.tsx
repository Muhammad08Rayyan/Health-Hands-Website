          ...
          <div className="flex justify-between items-center mb-12">
            ...
            <div>
              <a 
                ...
                className="group relative inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex flex-wrap justify-center items-center gap-8 pt-12 mt-12 border-t border-gray-200">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-base font-medium text-gray-700">Licensed Pharmacy</span>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-base font-medium text-gray-700">100% Genuine Medicines</span>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-base font-medium text-gray-700">Professional Care</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Prescription Medicines</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Over-the-Counter</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Temperature-Controlled Storage</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Mother & Baby Care</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Topical Medications</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Nutrition & Supplements</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Medical Instruments</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center group hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Professional Counseling</h4>
          ...
          <div className="bg-gray-50 rounded-3xl p-12 mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3">End-to-End Encryption</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Healthcare Compliance</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3">User Control</h4>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <div className="inline-block">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Quick answers to common questions about our pharmacy services and mobile app
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="divide-y divide-gray-100">
              ...
              {/* FAQ Item 1 */}
              <div className="group">
                <div className="p-6 hover:bg-gray-50 transition-colors duration-300 cursor-pointer">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-300">
                      How does the app work with in-store services?
                    </h3>
                  ...
                  <p className="text-gray-600 mt-3 leading-relaxed">
                    Our app seamlessly complements our physical pharmacy services. You can browse our complete medicine catalog, 
                    upload prescriptions, and place orders through the app. Then choose to either pick up your medications 
                    in-store or have them delivered to your location.
                  </p>
                </div>
              </div>
              ...
              <div className="group">
                <div className="p-6 hover:bg-gray-50 transition-colors duration-300 cursor-pointer">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-300">
                      How do you verify medication authenticity?
                    </h3>
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-blue-600 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  ...
                  <p className="text-gray-600 mt-3 leading-relaxed">
                    We employ multiple layers of verification to ensure medication authenticity. Our app includes advanced 
                    barcode and QR code scanning technology that instantly verifies medications against our secure database. 
                    We source exclusively from verified, licensed suppliers.
                  </p>
                </div>
              </div>
              ...
              <div className="group">
                <div className="p-6 hover:bg-gray-50 transition-colors duration-300 cursor-pointer">
                  ...
                  <p className="text-gray-600 mt-3 leading-relaxed">
                    Absolutely. We use enterprise-grade AES-256 encryption to protect all your health data both in transit 
                    and at rest. Your medical records and personal information are stored on secure, healthcare-compliant 
                    servers and are never shared without your consent.
                  </p>
                </div>
              </div>
              ...
              <div className="group">
                <div className="p-6 hover:bg-gray-50 transition-colors duration-300 cursor-pointer">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-300">
                      What makes your pharmacy different from delivery services?
                    </h3>
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-blue-600 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
              ...
              <div className="group">
                <div className="p-6 hover:bg-gray-50 transition-colors duration-300 cursor-pointer">
                  ...
                  <p className="text-gray-600 mt-3 leading-relaxed">
                    Yes, we offer emergency consultations via WhatsApp 24/7, even when our physical store is closed. 
                    Our licensed pharmacists are available to provide urgent medication guidance and health advice 
          ...
          <div className="text-center mt-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105"
              >
              ...
              <a 
                ...
                className="inline-flex items-center space-x-2 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
